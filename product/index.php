...
<div class="row">
  <div class="col-lg-4">
     ...
     <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="300px" height="500px" viewBox="0 0 1145 1800" xml:space="preserve">
      <image overflow="visible" width="1145" height="1800" xlink:href="../assets/mouth.png"></image>
...
<div class="form-group row" style="margin-top: 20px;">
  ...
  <h6 style="margin-top: 20px;">Implantes</h6>
   ...
   <div class="row col-md-12" id="customFields" style="margin-top: 20px;">
    <div class="row col-md-12" style="display: none;">
     <div class="col-md-2 mb-3">
        <a href="javascript:void(0);" id="addCF" class="btn"><i class="fa fa-plus-square" aria-hidden="true" style="color: #0fa260;font-size: 22px;"></i></a>
     </div>
      <div class="col-md-3 mb-3">
   ...
   <div class="form-group row" style="margin-top: 30px;">
    <label for="inputPassword" class="col-sm-2">Services:</label>
  ...
  <div class="form-group row" style="margin-top: 20px;">
    <label for="inputPassword" class="col-sm-2">Variety:</label>
    <div class="col-sm-6 form-group">
       <select id="inputState" class="form-select">
  ...
  <footer class="my-5 pt-5 text-muted text-center text-small">
   ...
   <script type="text/javascript">
     $(document).ready(function(){
         ...
         // alert(id);
         $("#customFields").append('<div class="row col-md-12"><div class="col-md-3 mb-3"><a href="javascript:void(0);" id="'+id+'"  class="remCF button button5">'+id+'</a></div><div class="col-md-3 mb-3"><select id="inputState" class="form-select"><option selected>Option 1</option><option>Option 2</option></select></div><div class="col-md-3 mb-3"><select id="inputState" class="form-select"><option selected>Option 1</option><option>Option 2</option></select></div><div class="col-md-3 mb-3"><select id="inputState" class="form-select"><option selected>Option 1</option><option>Option 2</option></select></div></div>');    
